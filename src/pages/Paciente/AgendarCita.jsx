...
const AgendarCita = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost:5000/api/pacientes/listarEspecialidades")
    ...
    useEffect(() => {
        if (form.especialidad) {
            axios.get(`http://localhost:5000/api/pacientes/listarMedicos/${form.especialidad}`)
    ...
    useEffect(() => {
        if (form.medico) {
            axios.get(`http://localhost:5000/api/pacientes/disponibilidadMedico/${form.medico}`)
                .then(res => {
